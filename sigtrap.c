...
FILE * output;			      // Edited by Matt Morrison 
				      // Originally FILE * output = DEFAULT_OP
                                      // First line of main contains additional edited code
...
{
    output = fopen("stdout", "w");    // Added line by Matt Morrison
